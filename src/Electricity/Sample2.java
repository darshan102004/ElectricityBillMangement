...
public class Sample2 extends JFrame implements ActionListener{
    ...
    Sample2(String meter,String person){
        ...
        JButton l1 = new JButton("Update Information");
        ...
        JButton l2 = new JButton("View Information");
        ...
        JButton l3 = new JButton("Pay Bill");
    ...
    public static void main(String[] args){
        new Sample2("", "Customer").setVisible(true);
    }
}