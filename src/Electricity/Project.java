...
public class Project extends JFrame implements ActionListener{
    ...
    this.meter = meter;
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("icon3/10.jpeg"));
        ...
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("icon/png1.png"));
        ...
        ImageIcon icon3 = new ImageIcon(ClassLoader.getSystemResource("icon/png1.png"));
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("icon/png1.png"));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(msg.equals("Customer Details")){
            ...
            new Report(meter).setVisible(true);
        }
        else if(msg.equals("Print")){
            new Print(meter).setVisible(true);
        }
